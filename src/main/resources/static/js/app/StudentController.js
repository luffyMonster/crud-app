...
angular.module('student-managament-app').controller('StudentController',
    ['StudentService', '$scope',  function( StudentService, $scope) {
        ...
        self.onlyDates = /^(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d$/;
        ...
        function removeStudent(id){
            ...
            if (!confirm("Are you sure delete user with id " + id + ' ?')) return;
